...
<html lang="en">
  ...
  <svg class="bi bi-display-fill mr-2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/phpPractice">Home</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="insert.php">Manage Posts</a>
      </li>
    </ul>
  </div>
</nav>
